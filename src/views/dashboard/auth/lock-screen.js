...
import { isResetPassword } from "../../../store/auth/authSlice.js";
import { useUpdatePasswordMutation } from "../../../slices/userApiSlice.js";
...
const LockScreen = () => {
  ...
  const handleReset = async (e) => {
    e.preventDefault();
    try {
      const res = await UpdatePassword(inputs).unwrap();
      dispatch(isResetPassword({ ...res }));
    } catch (err) {

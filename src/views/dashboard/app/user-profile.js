...
import HeaderProfile from "../../../components/partials/profile/HeaderProfile";
import { useQuery } from "@tanstack/react-query";
import { FetchOneUser, fetchUsers } from "../../../api/UserRequest.js";
            ...
            <Card className="p-0">
              <Card.Body className="p-0">
                <div className="user-tabing">
                  ...
                  >
                    <Nav.Item as="li" className="  col-sm-2 p-0 ">
                      <Nav.Link
                                                      ...
                                                      <Row className="align-items-center">
                                                        <Form.Group className="form-group col-sm-12">
                                                          ...
                                                          <Form.Control
                                                            ...
                                                            placeholder=" this is desc of this post..."
                                                          ></Form.Control>
                                                        </Form.Group>
                                                      </Row>
                                                      <Col
                                                      ...
                                                      >
                                                        <div className="">
                                                          <img
                                                            ...
                                                            alt="profile-pic"
                                                          />
                                                          <div className="p-image position-absolute top-0 end-0 ">
                            ...
                            <Tab.Content>
                              <Tab.Pane eventKey="about1">
                                ...
                                <Row className="mb-2">
                                  ...
                                  <div className="col-9">
                                    <p className="mb-0">
                                      Hi, I’m James, I’m 36 and I work as a
                                      Digital Designer for the “Daydreams”
                                      Agency in Pier 56
                                    </p>
                                  </div>
                                </Row>

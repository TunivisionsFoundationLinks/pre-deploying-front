...
const Pnational = () => {
  return (
    <>
      <ProfileHeader img={img7} title="Project National List" />
          ...
          <div className="d-grid gap-3 d-grid-template-1fr-19">
            <div className="card mb-0">
              ...
              <div className="card-body text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link to="/:id/group-detail">R & D</Link>
                  </h4>
            ...
            <Card className=" mb-0">
              ...
              <Card.Body className=" text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link to="/:id/group-detail">Graphics</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <div className="card mb-0">
              ...
              <div className="card-body text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link to="/:id/group-detail">Developer</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card className=" mb-0">
              ...
              <Card.Body className="text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link to="/:id/group-detail">Tester</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card className="mb-0">
              ...
              <Card.Body className="text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link to="/:id/group-detail">Events</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card>
              ...
              <Card.Body className=" text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link to="/:id/group-detail">Coder</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card>
              ...
              <Card.Body className=" text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link to="/:id/group-detail">Themes</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card>
              ...
              <Card.Body className="text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link to="/:id/group-detail">Review</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">

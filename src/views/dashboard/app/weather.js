                           ...
                           <Card.Body>
                              <Form>
                                 <Form.Group className="form-group">
                                    <Form.Label className="form-label" htmlFor="country-and-timezone">Country and Timezone</Form.Label>
                                 ...
                                 <Form.Group className="form-group">
                                    <Form.Label className="form-label" htmlFor="extended-days">Extended Days</Form.Label>
                                 ...
                                 <Form.Group className="form-group">
                                    <Form.Label className="form-label" htmlFor="temperature-unit">Temperature Unit</Form.Label>

                  ...
                  <Card.Body>
                    <div>
                      <div className="iq-email-list">
                        <Button
                          variant="danger"
                          className="btn-lg btn-block mb-3 p-2 w-100 d-flex align-items-center"
                          data-target="#compose-email-popup"
                          data-toggle="modal"
                        >
                          <i className="material-symbols-outlined me-2 writ-icon">
                            send
                          </i>
                          New Message
                        </Button>
                        ...
                        >
                          ...
                          >
                            <div className="d-flex align-items-center justify-content-between">
                              ...
                              <span className="badge bg-danger ms-2">4</span>
                            </div>
                          </Nav.Link>
                          <Nav.Link
                            role="button"
                        ...
                        <ul className="iq-email-ui iq-email-label list-inline p-0 m-0">
                          <li>
                            <Link to="#" className="d-flex align-items-center">
                              <i className="material-symbols-outlined md-18 text-danger">
                                trip_origin
                              </i>
                              Personal
                            </Link>
                          ...
                          <li>
                            <Link to="#" className="d-flex align-items-center">
                              <i className="material-symbols-outlined md-18 text-success">
                                trip_origin
                              </i>
                              Important
                            </Link>
                          ...
                          <li>
                            <Link to="#" className="d-flex align-items-center">
                              <i className="material-symbols-outlined md-18 text-info">
                                trip_origin
                              </i>
                              Private
                            </Link>
                          ...
                          <li>
                            <Link to="#" className="d-flex align-items-center">
                              <i className="material-symbols-outlined md-18 text-warning">
                                trip_origin
                              </i>
                              Private
                            </Link>
                            ...
                            <ul className="iq-email-sender-list">
                              <li className="iq-unread">
                                ...
                                >
                                  <div className="iq-email-sender-info">
                                    ...
                                    <span className="material-symbols-outlined iq-star-toggle text-warning md-20">
                                      star_border
                                    </span>
                                  ...
                                  <div className="iq-email-content">
                                    <Link to="#" className="iq-email-subject">
                                      ...
                                      &nbsp;–&nbsp;
                                      <span>
                                        @MackenzieBnio - Very cool :) Nicklas,
                                        You have a new direct message.
                                      </span>
                                    </Link>
                                    <div className="iq-email-date">
                                      08:00 am
                                    </div>
                                  </div>
                              ...
                              <li>
                                ...
                                >
                                  <div className="iq-email-sender-info">
                                    ...
                                    <span className="material-symbols-outlined iq-star-toggle md-20">
                                      star_border
                                    </span>
                                    <Link to="#" className="iq-email-title">
                                      Deray Billings (Me)
                                  ...
                                  <div className="iq-email-content">
                                    <Link to="#" className="iq-email-subject">
                                      ...
                                      <span>
                                        @LucasKriebel - Very cool :) Nicklas,
                                        You have a new direct message.
                                      </span>
                                    </Link>
                                    <div className="iq-email-date">
                              ...
                              <li>
                                ...
                                >
                                  ...
                                  <div className="iq-email-content">
                                    <Link to="#" className="iq-email-subject">
                                      Jecno Mac (@jecnomac) has sent you a
                                      direct message on Twitter! &nbsp;–&nbsp;
                                      <span>
                                        @LucasKriebel - Very cool :) Nicklas,
                                        You have a new direct message.
                              ...
                              <li>
                                ...
                                >
                                  ...
                                  <div className="iq-email-content">
                                    <Link to="#" className="iq-email-subject">
                                      Let Hunre (@lethunre) has sent you a
                                      direct message on Twitter! &nbsp;–&nbsp;
                                      <span>
                                        @LucasKriebel - Very cool :) Nicklas,
                                        You have a new direct message.
                              ...
                              <li className="iq-unread">
                                ...
                                >
                                  <div className="iq-email-sender-info">
                                    ...
                                    <span className="material-symbols-outlined iq-star-toggle md-20 text-warning">
                                      star_border
                                    </span>
                                    <Link to="#" className="iq-email-title">
                                      Megan Allen (Me)
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-sm-10">
                        ...
                        >
                          ...
                          <option defaultValue="Rick O'Shea">
                            Rick O'Shea
                          </option>
                    ...
                    <div className="form-group row align-items-center compose-bottom pt-3 m-0">
                      <div className="d-flex flex-grow-1 align-items-center">
                        ...
                        <div className="send-panel">
                          <label
                            className="ms-2 mb-0 soft-bg-danger rounded"
                            htmlFor="file"
                          >
                            {" "}
                            <input
                          ...
                          <label className="ms-2 mb-0 soft-bg-danger rounded">
                            {" "}
                            <Link to="#">
                              {" "}
                              <i className="ri-map-pin-user-line text-danger"></i>
                            </Link>{" "}
                          </label>
                          <label className="ms-2 mb-0 soft-bg-danger rounded">
                            {" "}
                            <Link to="#">
                              {" "}
                              <i className="ri-drive-line text-danger"></i>
                            </Link>{" "}
                          </label>
                          <label className="ms-2 mb-0 soft-bg-danger rounded">
                            {" "}
                            <Link to="#">
                              {" "}
                              <i className="ri-camera-line text-danger"></i>
                            </Link>{" "}
                          </label>
                          <label className="ms-2 mb-0 soft-bg-danger rounded">
                            {" "}
                            <Link to="#">
                              {" "}
                              <i className="ri-user-smile-line text-danger"></i>
                            </Link>{" "}
                          </label>
                        </div>
                      </div>

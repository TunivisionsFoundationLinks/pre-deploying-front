...
const PostDetailsClub = ({ createBy, Disc, files }) => {
          ...
          <div className="d-flex justify-content-between">
            <div className="me-3 w-auto h-50">
              <img
                ...
                src={`https://tlinkbackendserver.onrender.com/images/${club?.otherDetails?.profilePicture}`}
                alt=""
              />
            </div>
            <div className="w-100">
...
export default PostDetailsClub;
